        ...
        <section class="about-us">
            <div class="row">
                <div class="about-col">
                    ...
                    <p>Interesujemy się motoryzacją, jesteśmy na bieżąco z nowymi trendami poszczególnych marek, dlatego w naszej ofercie znajdziecie Państwo wyłącznie nowe samochody. Wyróżnia je nowoczesny design, bogate wyposażenie oraz niezwykły komfort jazdy na krótszych jak i dłuższych trasach. Działamy na terenie Białegostoku jak również całej Polski.</p>
                    <a href="" class="hero-btn red-btn">SPRAWDŹ DOSTĘPNE SAMOCHODY</a>
                </div>
                <div class="about-col">
